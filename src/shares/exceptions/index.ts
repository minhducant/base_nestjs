export const httpErrors = {
  ...
  PERMISSION_EXISTED: {
    ...
    code: 'PERMISSION_00001',
  },
  PERMISSION_EDITED_DENIED: {
    message: 'You can not access this permission',
    code: 'PERMISSION_00002',
  },
